...
function startSector(n){
  ...
  intro=(mapKind==='redSquare')?[{t:0,a:'SECTOR '+n,b:'RED SQUARE · MOSCOW'},
        ...
        {t:9.6,a:'LAUNCH TRUCK DEPLOYING',b:'PROTECTED FOR 12 SECONDS'}]:[{t:0,a:'SECTOR '+n,b:'CONCRETE CRUSHERS'},
         {t:2.4,a:'BREACH 3 COMPOUND PERIMETERS',b:'TAKE EACH FORTIFIED POSITION'},
         {t:4.8,a:'NEUTRALIZE ENEMY FORCES',b:'CLEAR ALL HOSTILES'},
         {t:7.2,a:'ELIMINATE HAMMER GOD',b:'TAKE DOWN THE ENEMY COMMANDER'}];
  introT=0;
}
var clearing=false;
