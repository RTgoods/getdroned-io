...
test('beam intersects the visible upper body, including enemies behind walls',()=>{
 const hits=[];const c={Math,mapKind:'compound',MW:20,TILE:34,WW:680,WH:340,player:{x:34,y:150},enemies:[{x:200,y:170,hp:100},{x:400,y:170,hp:2500},{x:400,y:250,hp:100},{x:0,y:150,hp:100}],ships:[],motorcade:[],refineries:[],aircraft:[],sams:[],aaGuns:[],edrones:[],tank:null,fx:[],damageWall:()=>{},hurtEnemy:(e,d)=>{hits.push(e.x);e.hp-=d;}};
